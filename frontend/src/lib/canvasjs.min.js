...
(function () {
	...
	function hb(h) {
		if (h._menuButton)
			h.exportEnabled
				? (V(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
				  La(h._menuButton),
				...
				function () {
					m ||
						...
						0 >= navigator.userAgent.search("MSIE") &&
							V(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
				},
				h.allDOMEventHandlers,
				!0
			);
	...
	function xa(h, m, r) {
		m.getAttribute("state") ||
			...
			(m.style.border = "none"),
			V(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
			...
			: this.parent &&
			  ...
			  (null === v
					...
					: 0 < this.parent.themeOptions[m].length &&
					  ((v = Math.min(this.parent.themeOptions[m].length - 1, v)), (h = this.parent.themeOptions[m][v])));
		this.themeOptions = h;
		...
		if (r(this.options.margin) && h.options.subtitles)
			for (var F = h.options.subtitles, v = 0; v < F.length; v++)
				if (
					...
					((r(F[v].verticalAlign) && "top" === this.verticalAlign) || F[v].verticalAlign === this.verticalAlign) &&
	...
	var ea = 20,
		...
		Va = {
			...
			subtitles: [
				{ fontFamily: Fa, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }
			],
			data: [
				{
	...
	var ea = 20,
		...
		ab = {
			...
			subtitles: [
				{ fontFamily: w, fontSize: A, fontColor: "#3A3A3A", fontWeight: "normal", verticalAlign: "top", margin: 5 }
			],
			data: [
				{
					indexLabelFontFamily: w,
	...
	var ea = 20,
		...
		bb = {
			...
			dark2: {
				...
				subtitles: [
					{ fontFamily: w, fontSize: A, fontColor: ga, fontWeight: "normal", verticalAlign: "top", margin: 5 }
				],
				toolbar: {
					itemBackgroundColor: "#666666",
					itemBackgroundColorOnHover: "#FF7372",
	...
	W.prototype.addTo = function (h, m, r, v) {
		...
		w.hasOwnProperty(h) ||
		(w.publicProperties && w.publicProperties.hasOwnProperty(h) && "readWrite" === w.publicProperties[h])
	...
	W.prototype.updateOption = function (h) {
		...
		this.theme && r(this.parent) && r(A) && r(I)
			? (v = r(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme])
			: this.parent &&
			  this.parent.themeOptions &&
			  ...
			  (null === I
					...
					: 0 < this.parent.themeOptions[A].length &&
					  ((v = Math.min(this.parent.themeOptions[A].length - 1, I)), (v = this.parent.themeOptions[A][v])));
		this.themeOptions = v;
	...
	W.prototype.dispatchEvent = function (h, m, r) {
		if (h && this._eventListeners[h]) {
			m = m || {};
			for (var v = this._eventListeners[h], w = 0; w < v.length; w++) v[w].eventHandler.call(v[w].context, m);
		}
		...
		if (0 !== this.fontSize) {
			...
			for (r = 0; r < this._wrappedText.lines.length; r++) {
				...
				if ("right" === this.horizontalAlign || "right" === this.textAlign)
					...
					v = (this.width - (this.leftPadding + this.rightPadding)) / 2 - A.width / 2 + this.leftPadding;
		...
		if (this.text) {
			...
			r(this.padding) || "number" !== typeof this.padding
				? r(this.padding) ||
				  ...
				  ((Q = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0),
				  (Q += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0))
				: (Q = 2 * this.padding);
	...
	w = Pa.Chart = (function () {
		...
		function A(a, d, c, b, e, f, l, s, C, k) {
			...
			C && 0 < l.thickness
				...
				: 0 < l.thickness && (a.moveTo(d, c + n), a.lineTo(b, c + n), a.moveTo(d, e - n), a.lineTo(b, e - n));
			a.stroke();
			a.restore();
		}
		function P(a, d) {
			...
			if (this.options.stripLines && 0 < this.options.stripLines.length)
				for (a = 0; a < this.options.stripLines.length; a++)
					this.stripLines.push(
						new Q(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId, this)
					);
						...
						function () {
							d
								...
								: (V(a._zoomButton, {
								  ...
								  0 >= navigator.userAgent.search("MSIE") &&
										V(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
						},
						this.allDOMEventHandlers
					);
					J(
						...
						function () {
							d ||
								...
								0 >= navigator.userAgent.search("MSIE") &&
									V(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
						},
						this.allDOMEventHandlers
					);
				}
					...
					: ((d = !1),
					  ...
					  J(
							...
							function () {
								...
								0 >= navigator.userAgent.search("MSIE") &&
									V(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
		...
		m.prototype._initialize = function () {
			this.isNavigator =
				r(this.parent) || r(this.parent._defaultsKey) || "Navigator" !== this.parent._defaultsKey ? !1 : !0;
			...
			if (this.options.data) {
				for (var c = 0; c < this.options.data.length; c++)
					if (
						(a++, !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type))
					) {
						...
						if (this.options.axisY && 0 < this.options.axisY.length) {
							if (!this.axisY.length)
								for (var c = 0; c < this.options.axisY.length; c++)
									"normal" === this.plotInfo.axisPlacement
										? this._axes.push(
												(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left"))
										  )
										: "xySwapped" === this.plotInfo.axisPlacement &&
										  this._axes.push(
												(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"))
										  );
							this.data[d].axisY =
								this.axisY[
							...
							this.axisY.length ||
								("normal" === this.plotInfo.axisPlacement
									...
									: "xySwapped" === this.plotInfo.axisPlacement &&
									  this._axes.push(
											(this.axisY[0] = new E(this, "axisY", this.options.axisY, 0, "axisY", "bottom"))
									  )),
					...
					if ("secondary" === this.data[d].axisYType)
						if (this.options.axisY2 && 0 < this.options.axisY2.length) {
							if (!this.axisY2.length)
								for (c = 0; c < this.options.axisY2.length; c++)
									"normal" === this.plotInfo.axisPlacement
										...
										: "xySwapped" === this.plotInfo.axisPlacement &&
										  this._axes.push(
												(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"))
										  );
							this.data[d].axisY =
								this.axisY2[
							...
							this.axisY2.length ||
								("normal" === this.plotInfo.axisPlacement
									? this._axes.push(
											(this.axisY2[0] = new E(this, "axisY2", this.options.axisY2, 0, "axisY", "right"))
									  )
									: "xySwapped" === this.plotInfo.axisPlacement &&
									  this._axes.push(
											(this.axisY2[0] = new E(this, "axisY2", this.options.axisY2, 0, "axisY", "top"))
									  )),
						...
						if (this.options.axisX && 0 < this.options.axisX.length) {
							if (!this.axisX.length)
								for (c = 0; c < this.options.axisX.length; c++)
									"normal" === this.plotInfo.axisPlacement
										? this._axes.push(
												(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom"))
										  )
										: "xySwapped" === this.plotInfo.axisPlacement &&
										  this._axes.push(
												(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left"))
										  );
							this.data[d].axisX =
								this.axisX[
						...
						if (this.options.axisX2 && 0 < this.options.axisX2.length) {
							if (!this.axisX2.length)
								for (c = 0; c < this.options.axisX2.length; c++)
									"normal" === this.plotInfo.axisPlacement
										? this._axes.push(
												(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top"))
										  )
										: "xySwapped" === this.plotInfo.axisPlacement &&
										  this._axes.push(
												(this.axisX2[c] = new E(
							...
							this.axisX2.length ||
								("normal" === this.plotInfo.axisPlacement
									? this._axes.push(
											(this.axisX2[0] = new E(this, "axisX2", this.options.axisX2, 0, "axisX", "top"))
									  )
									: "xySwapped" === this.plotInfo.axisPlacement &&
									  this._axes.push(
			...
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				...
				for (q in s)
					s.hasOwnProperty(q) &&
						...
						q < c.viewPortMin ||
							q > c.viewPortMax ||
							(a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))));
			}
		};
		m.prototype._processStacked100PlotUnit = function (a) {
			if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
				for (
					var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, s = !1, C = [], k = 0;
					...
					for (n = 0; n < k.dataPoints.length; n++) {
						...
						if (!(b < r) || p) {
							...
							null === e
								...
								: (f < d.viewPortMin && (d.viewPortMin = f), l > d.viewPortMax && (d.viewPortMax = l));
						}
					}
		...
		m.prototype._processSpecificPlotUnit = function (a) {
			if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
				for (
					...
					if ((s.dataPoints[C].x && s.dataPoints[C].x.getTime) || "dateTime" === s.xValueType) f = !0;
					for (C = 0; C < s.dataPoints.length; C++)
						"undefined" !== typeof s.dataPoints[C].isCumulativeSum && !0 === s.dataPoints[C].isCumulativeSum
							? ((s.dataPointEOs[C].cumulativeSumYStartValue = 0),
							  (s.dataPointEOs[C].cumulativeSum = 0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
							...
							: ((e = "number" !== typeof s.dataPoints[C].y ? 0 : s.dataPoints[C].y),
							  (s.dataPointEOs[C].cumulativeSumYStartValue = 0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
							  (s.dataPointEOs[C].cumulativeSum = 0 === C ? e : s.dataPointEOs[C - 1].cumulativeSum + e),
							  (b += e));
					for (C = 0; C < s.dataPoints.length; C++)
						if (
		...
		m.prototype.calculateAutoBreaks = function () {
								...
								for (s = 0; s < h.dataPoints.length; s++)
									if (
										...
										var m =
											...
											100;
										if (
											(g = "waterfall" === a.type ? h.dataPointEOs[s].cumulativeSum : h.dataPoints[s].y) &&
											g.length
										)
					...
					for (
						...
						if (!(4 > n.dataPoints.length))
							for (l = 0; l < n.dataPoints.length; l++)
								(g =
									((d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) /
									100),
			...
			for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
				if (
					...
					for (
						var s = 0;
						s < 100 / Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) || 10, 10);
						s++
					)
						...
						for (s = 0; s < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); s++)
							(b = a(
								...
								this._axes[l].scaleBreaks._appliedBreaks.push(
									this._axes[l].scaleBreaks.autoBreaks[this._axes[l].scaleBreaks.autoBreaks.length - 1]
								);
			...
			m.capturedEventParam &&
				...
				"mouseup" === c &&
					...
					b.chart.overlaidCanvas.releaseCapture
						? b.chart.overlaidCanvas.releaseCapture()
						: document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)),
				b.hasOwnProperty(c) &&
								...
								? ((e = c.x1),
								  ...
								  0 > w
										? ((q = n.point.x - ("horizontal" === B ? C : C - t / 2) - l - b),
										  q < e &&
												((q = "auto" === x ? Math.max(n.point.x, e) + l : e + l), (E = q + C > n.point.x)))
						...
						for (var B = !1, u = 0; u < n.length; u++)
							if (
								...
								if ("number" !== typeof n[u].y)
									0 < u && !(k.connectNullData || B || r) && (c.stroke(), v && b.stroke()), (B = !0);
								else {
					...
					if (0 < t.length)
						for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
							if (
								...
								l = a.axisX.reversed
									? (l + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + n) * p) << 0
									: (l - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + n) * p) << 0;
					...
					if (0 < t.length) {
						...
						for (f = 0; f < t.length; f++)
							if (
								...
								s = a.axisX.reversed
									? (s + (a.plotType.totalDataSeries * p) / 2 - (a.previousDataSeriesCount + n) * p) << 0
									: (s - (a.plotType.totalDataSeries * p) / 2 + (a.previousDataSeriesCount + n) * p) << 0;
						...
						for (k = 0; k < u.length; k++)
							if (
								...
								if (
									...
									(s[b] = u[k].y + (s[b] ? s[b] : 0)),
										0 < s[b] && ((D = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(s[b])));
								else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
									(C[b] = u[k].y + (C[b] ? C[b] : 0)),
										(n = l[b] ? l[b] : q),
										...
										? (!d && g.connectNullData
												? (f.setLineDash &&
														(g.options.nullDataLineDashType ||
															(c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
														((d = r),
														(c = u),
														(r = n.x),
														(u = n.y),
									...
									: ((m = a.axisX.convertValueToPixel(y)),
									  ...
									  d || c
											? (!d && g.connectNullData
													? (f.setLineDash &&
															(g.options.nullDataLineDashType ||
																(T === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
															((d = m),
															(c = u),
															(m = n.x),
															(u = n.y),
									  ...
									  (n = { x: m, y: u }),
									  r < t.length - 1 &&
											(E !== (t[r].lineColor || w) || T !== (t[r].lineDashType || g.lineDashType)) &&
											(b(),
											(E = t[r].lineColor || w),
											(f.strokeStyle = E),
											f.setLineDash &&
										...
										? (!y && z.connectNullData
												? (b.setLineDash &&
														(z.options.nullDataLineDashType ||
															(x === z.lineDashType && z.lineDashType !== z.nullDataLineDashType)) &&
														((y = k.pop()),
														(x = k[k.length - 1]),
														d(),
														b.moveTo(u.x, u.y),
								...
								if ("number" !== typeof ia.y) z.connectNullData || aa || m || d(), (aa = !0);
									...
									m || aa
										? (!m && z.connectNullData
												? (b.setLineDash &&
														(z.options.nullDataLineDashType ||
															(u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType)) &&
														((m = k.pop()),
														(u = k[k.length - 1]),
														d(),
														b.moveTo(r.x, r.y),
							...
							if (
								...
								var g = q[e].z,
									m =
										2 *
										Math.max(
											Math.sqrt((s === h ? r / 2 : t + ((r - t) / (s - h)) * (g - h)) / Math.PI) << 0,
											1
										),
					...
					if (0 < x.length)
						for (var B = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
							if (
								...
								c.lineWidth = w;
								c.strokeStyle = e;
								c.rect(D - E, Math.min(k, n) - E, z - D + 2 * E, Math.max(k, n) - Math.min(k, n) + 2 * E);
								c.stroke();
								c.save();
								0 < J &&
									(c.beginPath(),
						...
						for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
							if (
								...
								var m = a.axisX.reversed
										? (b + (a.plotType.totalDataSeries * k) / 2 - (a.previousDataSeriesCount + n) * k) << 0
										: (b - (a.plotType.totalDataSeries * k) / 2 + (a.previousDataSeriesCount + n) * k) << 0,
						...
						for (var E = B._colorSet, s = 0; s < D.length; s++) {
							...
							T.length =
								"number" === typeof T.length
									...
									: u;
							T.thickness =
								"number" === typeof T.thickness ? (0 > T.thickness ? 0 : Math.round(T.thickness)) : 2;
							var S = {
								color: D[s].stemColor
									? D[s].stemColor
									: D[s].color
							...
							S.thickness =
								"number" === typeof S.thickness ? (0 > S.thickness ? 0 : Math.round(S.thickness)) : 2;
							...
							if (
								...
								if (D[s].indexLabel || B.indexLabel || D[s].indexLabelFormatter || B.indexLabelFormatter)
									this._indexLabels.push({
										chartType: "error",
										dataPoint: D[s],
										dataSeries: B,
					...
					if (0 < t.length) {
						...
						for (f = 0; f < t.length; f++)
							if (
								...
								h = a.axisX.reversed
									? (h + (a.plotType.totalDataSeries * n) / 2 - (a.previousDataSeriesCount + p) * n) << 0
									: (h - (a.plotType.totalDataSeries * n) / 2 + (a.previousDataSeriesCount + p) * n) << 0;
										...
										? (n.connectNullData && !q
												? (b.setLineDash &&
														(n.options.nullDataLineDashType ||
															(z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType)) &&
					...
					if (0 < m.length)
						for (var x = 5 < q && r.bevelEnabled ? !0 : !1, B = !1, w = null, z = null, l = 0; l < m.length; l++)
							if ((m[l].getTime ? (n = m[l].x.getTime()) : (n = m[l].x), "number" !== typeof m[l].y)) {
								...
								s = a.axisX.reversed
									? (s + (a.plotType.totalDataSeries * q) / 2 - (a.previousDataSeriesCount + g) * q) << 0
									: (s - (a.plotType.totalDataSeries * q) / 2 + (a.previousDataSeriesCount + g) * q) << 0;
								...
								var S,
									T = s;
								S =
									("undefined" !== typeof m[l].isIntermediateSum && !0 === m[l].isIntermediateSum) ||
								...
								0 < l &&
									...
									c.lineTo(T, S - y),
									0 < u && c.stroke(),
									v && (b.beginPath(), b.moveTo(w, z - y), b.lineTo(T, S - y), 0 < u && b.stroke()));
								B = !1;
								w = A;
								z = 0 < m[l].y ? h : k;
								T = m[l].lineDashType
		...
		m.prototype.renderPie = function (a) {
				...
				if (k && n) {
					for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
						...
						if (k.indexLabelFormatter || f.indexLabelFormatter)
							s = { chart: m.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
					...
					for (e = 0; e < n.length; e++)
						(h = g[(c + e) % n.length]),
							1 < a &&
								...
								h.midAngle < Math.PI / 2 + u &&
								(f <= a / 2 && !p ? ((h.hemisphere = "right"), f++) : ((h.hemisphere = "left"), (p = !0)));
					p = !1;
					for (e = 0; e < n.length; e++)
						(h = g[(d + e) % n.length]),
							1 < b &&
								...
								h.midAngle < (3 * Math.PI) / 2 + u &&
								(l <= b / 2 && !p ? ((h.hemisphere = "left"), l++) : ((h.hemisphere = "right"), (p = !0)));
				}
			}
			function c(a) {
			...
			function l() {
				...
				for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
					if (
						k.radius ||
						(!k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= E)
					)
						l = !1;
					l && (z -= d);
					d = 0;
								...
								if (0 > B) {
									...
									"right" === h.hemisphere
										? ((F = f(a, r)),
										  (D = -1 * (B - F)),
										  (I = f(u, D)),
										  +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(a, -(D - I)))
										: ((F = f(u, r)),
										  (D = -1 * (B - F)),
										  (I = f(a, D)),
										  +I.toFixed(y) < +D.toFixed(y) && +F.toFixed(y) <= +r.toFixed(y) && f(u, -(D - I)));
								}
							}
						}
					} else
							...
							(u = u = 0),
								...
								0 < u &&
									...
									Math.abs(h.indexLabelTextBlock.x - x.x) < z &&
										((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
							...
							if (((f = !1), (s = g[k]), s.indexLabelText)) {
								...
								if (null !== l) {
									...
									if ((q = 0 > B)) {
										...
										q =
											s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < h.indexLabelTextBlock.x - p ||
											q > u + p ||
											r > C + p ||
											m < t - p
												? !1
			...
			function h() {
				...
				if (m.subtitles)
					for (var a = 0; a < m.subtitles.length; a++) {
						var b = m.subtitles[a];
						(b.dockInsidePlotArea || ("center" === b.horizontalAlign && "center" === b.verticalAlign)) &&
							b.render();
					}
				m.legend &&
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				...
				if (0 !== B) {
					a =
						a ||
						("undefined" !== typeof k.indexLabel && null !== k.indexLabel && 0 < k.indexLabel.toString().length);
					var z =
		...
		m.prototype.renderFunnel = function (a) {
				...
				if (u && y) {
					...
					for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
						...
						"inside" === u.indexLabelPlacement &&
							((C[z] = z !== da ? (u.reversed ? R[z].x2 - R[z].x1 : R[z].x3 - R[z].x4) : R[z].x3 - R[z].x6),
							20 > C[z] &&
								((C[z] = z !== da ? (u.reversed ? R[z].x3 - R[z].x4 : R[z].x2 - R[z].x1) : R[z].x2 - R[z].x1),
								(C[z] /= 2)));
						...
						if (u.indexLabelFormatter || b.indexLabelFormatter)
							w = { chart: L.options, dataSeries: u, dataPoint: b, total: B.total, percent: B.percent };
			...
			function e() {
				...
				for (
					var g,
						k = J - $ - X / 2,
						k = u.options.indexLabelMaxWidth ? (u.indexLabelMaxWidth > k ? k : u.indexLabelMaxWidth) : k,
						l = H.length - 1;
					0 <= l;
					l--
				) {
				...
				if (e)
					for (l = H.length - 1; 0 <= l; l--)
						(a = R[l]),
							...
							u.reversed
								? (H[l].textBlock.y + H[l].height > pa + B && (H[l].textBlock.y = pa + B - H[l].height),
								  H[l].textBlock.y < ua - B && (H[l].textBlock.y = ua - B))
								: (H[l].textBlock.y < pa - B && (H[l].textBlock.y = pa - B),
								  H[l].textBlock.y + H[l].height > ua + B && (H[l].textBlock.y = ua + B - H[l].height));
			}
			function f() {
				var a, b, c, d;
					...
					for (var e = 0; e < R.length; e++)
						0 == H[e].textBlock.text.length
							...
							: ((a = R[e]),
							  ...
							  u.reversed
									? (H[e].textBlock.y + H[e].height > pa + B && (H[e].textBlock.y = pa + B - H[e].height),
									  H[e].textBlock.y < ua - B && (H[e].textBlock.y = ua - B))
									: (H[e].textBlock.y < pa - B && (H[e].textBlock.y = pa - B),
									  H[e].textBlock.y + H[e].height > ua + B && (H[e].textBlock.y = ua + B - H[e].height)));
				else
						...
						for (var s = H.length - 1; 0 <= s; s--)
							!H[s].isDirty &&
								...
								!(k >= H.length - 1) &&
									...
									(H[s].textBlock.y =
										H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1));
					}
			...
			if (!(0 >= a.dataSeriesIndexes.length)) {
				for (
					...
					if (
						...
						!F &&
							...
							(F = !0),
						(!F && "function" === typeof u.indexLabelFormatter) || "function" === typeof y[S].indexLabelFormatter)
					)
						F = !0;
				F =
					F ||
				...
				if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
					...
					if (-1 !== S) {
						...
						F &&
							u.visible &&
							("inside" === u.indexLabelPlacement || L.animationEnabled || n(P), L.animationEnabled || t());
						if (!F)
							for (G = 0; G < y.length; G++)
								(z = u.dataPointIds[G]),
									(a = {
		...
		m.prototype.print = function () {
			...
			b.document.body &&
				...
				((b.document.body.style.margin = "0px 0px 0px 0px"), (b.document.body.style.padding = "0px 0px 0px 0px"));
			b.document.close();
			setTimeout(function () {
				b.focus();
				b.print();
		...
		X.prototype.getDataPointAtX = function (a, d) {
				...
				(this.axisX.logarithmic
					? ((n = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)),
					  (n =
							1 < n
								? Math.min(
										Math.max(
											(((this.dataPoints.length - 1) / n) * Math.log(a / this.dataPoints[0].x)) >> 0,
											0
										),
					...
					: ((n = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
					  (n =
							0 < n
								? Math.min(
										Math.max((((this.dataPoints.length - 1) / n) * (a - this.dataPoints[0].x)) >> 0, 0),
										this.dataPoints.length
								  )
								: 0)));
			for (;;) {
			...
			return d || (c.dataPoint.x.getTime ? c.dataPoint.x.getTime() : c.dataPoint.x) !== (a.getTime ? a.getTime() : a)
				? d && null !== c.dataPoint
					? c
					: null
				: c;
		...
		X.prototype.getDataPointAtXY = function (a, d, c) {
			...
			if ("none" !== this.chart.plotInfo.axisPlacement)
				if (
					((p = (this.chart.axisX[0] ? this.chart.axisX[0] : this.chart.axisX2[0]).getXValueAt({ x: a, y: d })),
					this.axisX.logarithmic)
				)
					var q = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
						p =
							1 < q
								? Math.min(
										Math.max(
											(((this.dataPoints.length - 1) / q) * Math.log(p / this.dataPoints[0].x)) >> 0,
											0
										),
										this.dataPoints.length
								  )
					...
					(q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x),
						(p =
							0 < q
								? Math.min(
										Math.max((((this.dataPoints.length - 1) / q) * (p - this.dataPoints[0].x)) >> 0, 0),
										this.dataPoints.length
								  )
								: 0);
			for (;;) {
					...
					if (q) {
						switch (this.type) {
							...
							case "scatter":
								...
								m <= w && b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m });
								q = Math.abs(q.x1 - a);
								q <= r ? (r = q) : 0 < l ? k++ : n++;
								m <= v / 2 && (h = !0);
								break;
							...
							case "bubble":
								...
								m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
								m <= v / 2 &&
									(b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }), (h = !0));
								break;
							case "pie":
							case "doughnut":
								v = q.center;
								...
								m < q.radius &&
									...
									(v = Number(((((180 * (q.startAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
									(w = Number(((((180 * (q.endAngle / Math.PI)) % 360) + 360) % 360).toFixed(12))),
									0 === w && 1 < q.endAngle && (w = 360),
									v >= w && 0 !== g.y && ((w += 360), m < v && (m += 360)),
									m > v &&
										m < w &&
										(b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
								break;
							case "funnel":
							case "pyramid":
								m = q.funnelSection;
		...
		E.prototype.createLabels = function () {
			...
			if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
				...
				if (this.logarithmic && !this.equidistantInterval)
					for (
						this.logLabelValues || ((this.logLabelValues = []), this.createExtraLabelsForLog()), b = 0, g = q;
						...
						for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
							if (!this._labels[c].breaksLabelType) {
								...
								if (
									...
									(n =
										0 != this.labelAngle
											? (k - (m + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) /
											  Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
											: f),
		...
		E.setLayout = function (a, d, c, b, e, f) {
			...
			for (
				var w = (v = 0), u = 0, y = 0, x = 0, B = 0, D = 0, z, E, A = (h = 0), F, I, J, t = (F = I = J = !1), g = 0;
				g < q.length;
				g++
			)
				q[g] &&
			...
			if ("normal" === e) {
				for (var y = [], x = [], B = [], D = [], K = [], N = [], O = [], P = []; 4 > v; ) {
							...
							(d[g].lineCoordinates.x1 = Math.round(f.x1 + R + M)),
								...
								"inside" === d[g].labelPlacement &&
									...
									(d[g].lineCoordinates.y1 =
										d[g - 1].bounds.y1 - x[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)),
								(d[g].bounds = {
									x1: l,
									y1: h + (Y + V - x[g] - Q),
									x2: m,
						...
						for (g = 0; g < c.length; g++)
							(M = n.isNavigator ? 0 : 10),
								c[g] &&
									...
									(c[g].bounds = { x1: l - (B[g] + U), y1: h, x2: m, y2: k, width: m - l, height: k - h }),
									c[g].title &&
					...
					if (0 < v) {
						if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = K[v - 1][g] === K[v][g] ? !0 : !1;
						else t = !0;
						if (d && 0 < d.length) for (g = 0; g < d.length; g++) F = N[v - 1][g] === N[v][g] ? !0 : !1;
						else F = !0;
						if (c && 0 < c.length) for (g = 0; g < c.length; g++) I = O[v - 1][g] === O[v][g] ? !0 : !1;
						else I = !0;
						if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = P[v - 1][g] === P[v][g] ? !0 : !1;
						else J = !0;
					}
					if (t && F && I && J) break;
					v++;
				...
				for (N = []; 4 > v; ) {
						...
						for (g = 0; g < c.length; g++)
							(c[g].lineCoordinates = {}),
								...
								c[g].labelAutoFit &&
									...
									(0 < !a.length &&
										(l =
											0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l),
									0 < !d.length &&
					...
					if (b && 0 < b.length)
						for (g = 0; g < b.length; g++)
							(b[g].lineCoordinates = {}),
								(l = Math.round(f.x1 + X + e)),
								(m = Math.round(f.x2 - W - V > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - W - V)),
								b[g] &&
									b[g].labelAutoFit &&
									!r(B) &&
									(0 < !a.length &&
										(l =
											0 < b[g].labelAngle ? Math.max(l, B) : 0 === b[g].labelAngle ? Math.max(l, B / 2) : l),
									0 < !d.length && (m -= D / 2)),
					...
					if (b && 0 < b.length)
						for (g = b.length - 1; 0 <= g; g--)
							b[g] &&
								...
								(b[g].bounds = { x1: l, y1: h + (b[g].margin + G), x2: m, y2: k, width: m - l, height: Q }),
								b[g].title &&
									(b[g]._titleTextBlock.maxWidth =
										0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width
											? b[g].titleMaxWidth
					...
					if (a && 0 < a.length)
						for (g = 0; g < a.length; g++) {
							...
							h =
								b && 0 < b.length
									? Math.round(
											b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(M, 10) ? Math.max(M, 10) : f.y1
									  )
									: f.y1 < Math.max(M, 10)
									? Math.max(M, 10)
									: f.y1;
							...
							if (c && 0 < c.length)
								for (M = 0; M < c.length; M++)
									c[M] &&
										c[M].labelAutoFit &&
										((m =
											0 > c[M].labelAngle ? Math.max(m, y) : 0 === c[M].labelAngle ? Math.max(m, y / 2) : m),
							...
							a[g].bounds = { x1: m - (A[g] + O), y1: h, x2: m, y2: k, width: m - l, height: k - h };
							a[g].title &&
								(a[g]._titleTextBlock.maxWidth =
					...
					if (0 < v) {
						...
						if (c && 0 < c.length) for (g = 0; g < c.length; g++) I = E[v - 1][g] === E[v][g] ? !0 : !1;
						else I = !0;
						if (b && 0 < b.length) for (g = 0; g < b.length; g++) J = u[v - 1][g] === u[v][g] ? !0 : !1;
						else J = !0;
					}
					if (t && F && I && J) break;
					v++;
						...
						if (!(e[c].endValue < this.conversionParameters.minimum))
							if (d)
								if (e[c].startValue < this.conversionParameters.minimum) {
									if (
										e[c].size &&
										this.conversionParameters.minimum + (b * (e[c].endValue - e[c].startValue)) / e[c].size <
											e[c].endValue
									) {
					...
					a > e[f].endValue ||
						(a <= e[f].startValue && d >= e[f].endValue
							...
							? (c =
									(c / e[f].endValue) *
									a *
									Math.pow(e[f].size, Math.log(e[f].endValue / a) / Math.log(e[f].endValue / e[f].startValue)))
							: a <= e[f].startValue && d <= e[f].endValue
							? (c =
									(c / d) *
									e[f].startValue *
							...
							? ((b = (b / a[e].endValue) * this.viewportMinimum),
							  (c =
									0 < a[e].spacing.toString().indexOf("%")
										...
										: c -
										  (Math.min(a[e].spacing, 0.1 * c) * Math.log(a[e].endValue / this.viewportMinimum)) /
												Math.log(a[e].endValue / a[e].startValue)))
										...
										? c *
										  (1 -
												((parseFloat(a[e].spacing) / 100) *
													...
													Math.log(a[e].endValue / a[e].startValue))
										: c -
										  (Math.min(a[e].spacing, 0.1 * c) * Math.log(this.viewportMaximum / a[e].startValue)) /
												Math.log(a[e].endValue / a[e].startValue))));
			else
			...
			if ("bottom" === this._position || "top" === this._position)
				this.logarithmic
					? ((d.lnLogarithmBase = Math.log(this.logarithmBase)),
					  (d.pixelPerUnit = ((this.reversed ? -1 : 1) * c * d.lnLogarithmBase) / Math.log(Math.abs(b))))
			...
			if (this.logarithmic) this.calculateLogarithmicAxisParameters();
				...
				if (this.scaleBreaks)
					for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++)
						if (
							((!r(this.sessionVariables.newViewportMinimum) &&
								this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[b].startValue) ||
							...
							((!r(this.sessionVariables.newViewportMaximum) &&
								this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[b].endValue) ||
				...
				if ("axisX" === this.type && c) {
					...
					this.interval =
						this.options && 0 < this.options.interval ? this.options.interval : E.getNiceNumber(b / (a - 1), !0);
		...
		E.prototype.calculateLogarithmicAxisParameters = function () {
			...
			if (this.scaleBreaks)
				for (l = 0; l < this.scaleBreaks._appliedBreaks.length; l++)
					if (
						((!r(this.sessionVariables.newViewportMinimum) &&
							this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[l].startValue) ||
							(!r(this.options.minimum) &&
						...
						((!r(this.sessionVariables.newViewportMaximum) &&
							this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[l].endValue) ||
							(!r(this.options.maximum) &&
			...
			"axisX" === this.type
				...
				: "axisY" === this.type &&
				  ...
				  1 === b && 1 === e
						...
						: 1 === e / b
						? ((l = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
						  (e *= l),
						  (b /= l))
						: b > e
						? ((l = Math.min((b / e) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5))),
						  1 <= e ? (b = e / l) : (e = b * l))
						: ((l = Math.min((e / b) * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04))),
						  1 !== e && (e *= l),
						  1 !== b && (b /= l)),
				  (f =
						Infinity !== this.dataInfo.minDiff
			...
			if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
				this.viewportMinimum =
					"axisX" === this.type
						? b / Math.sqrt(f)
						: Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(b) / d / this.interval));
			if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
				this.viewportMaximum =
					"axisX" === this.type
						? e * Math.sqrt(f)
		...
		ga.prototype.createUserOptions = function (a) {
			if ("undefined" !== typeof a || this.options._isPlaceholder) {
				...
				this.options._isPlaceholder ||
					(Da(this.parent[this.optionsName]), (d = this.parent.options[this.optionsName].indexOf(this.options)));
		...
		ca.prototype.render = function (a, d, c) {
			...
			this.labelMaxHeight =
				r(this.options.labelWrap) || this.labelWrap ? 0.3 * this.chart.height : 2 * this.labelFontSize;
			...
			if (this.snapToDataPoint) {
				...
				if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
					...
					if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
						for (
							var w = Math.abs(a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])), u = 0, t = 0;
							t < n.length;
							t++
						)
						...
						for (
							var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = (u = 0), t = (A = 0);
							t < n.length;
							t++
						)
							if (n[t].dataPoint.y && n[t].dataPoint.y.length)
						...
						for (
							var w = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), B = (x = u = 0), t = 0;
							t < n.length;
							t++
						)
							if (n[t].dataPoint.y && n[t].dataPoint.y.length)
					...
					if ("bottom" === this.parent._position || "top" === this.parent._position) {
						...
						k.y =
							...
							("top" === this.parent._position ? -k.height + this.parent.tickLength : k.fontSize / 2) +
							2;
					...
					if (
						...
						for (
							w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = B = x = u = 0;
							t < n.length;
							t++
						)
							if (n[t].dataPoint.y && n[t].dataPoint.y.length)
					...
					if (
						...
						for (t = u = 0; t < y.dataPoint.y.length; t++)
							(u = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[t]))), u < w && ((w = u), (b = t));
						v =
							1 === q.lineWidth % 2
								? (this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0) + 0.5
								: this.parent.convertValueToPixel(y.dataPoint.y[b]) << 0;
						...
						"waterfall" === this.parent.dataSeries[A].type
							? ((v =
									1 === q.lineWidth % 2
										? (this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum) <<
												0) +
										  0.5
				...
				if ("xySwapped" === this.chart.plotInfo.axisPlacement)
					...
					(k.text = this.labelFormatter
						...
						: r(this.options.label)
						? ha(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
						: this.label),
						(k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2),
						k.y - k.fontSize / 2 < this.chart.bounds.y1
							? (k.y = this.chart.bounds.y1 + k.fontSize / 2 + 2)
				...
				"waterfall" === c.type
					...
					? (f = b.toolTipContent
							...
							: "<span data-color='\"" +
							  (this.options.fontColor ? "" : "'{color}'") +
							  "\"'>" +
							  (b.name ? "{name}:</span>&nbsp;&nbsp;" : b.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") +
							  "{y}")
					: "rangeColumn" === c.type ||
					  "rangeBar" === c.type ||
					  "rangeArea" === c.type ||
